...
#define FIREBASE_HOST "https://esp32rtdb-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "vCb6wPaPJQn9FBs8tp2QzhuOPbi3zcrDx3mKvC14"
...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  WiFi.begin(W IFI_STA_NAME, WIFI_STA_PASS);
